<script>
  ...
  export let renderMode = 'all'; // 'all' | 'background' | 'slots'
...
>
  <!-- Background, Highlight, and Decor only in 'all' or 'background' modes -->
  {#if renderMode === 'all' || renderMode === 'background'}
  ...
  <!-- Slots only in 'all' or 'slots' modes -->
